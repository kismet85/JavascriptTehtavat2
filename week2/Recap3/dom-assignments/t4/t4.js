...
function calculateEculidianDistance(x1, y1, x2, y2)
{
    return Math.sqrt(x2- x1, 2) + Math.pow((y2-y1, 2));
}

function sortRestaurants(restaurants, userLocation)
{
  restaurants.sort((a, b) => {
    const distanceA = calculateEculidianDistance(a.location.latitude, a.location.longitude, userLocation.latitude, userLocation.longitude);
    const distanceB = calculateEculidianDistance(b.location.latitude, b.location.longitude, userLocation.latitude, userLocation.longitude);
    return distanceA - distanceB;
})
}

function displaySortedRestaurantsInTable(restaurants) {
...
sortRestaurants(restaurants, userLocation);

displaySortedRestaurantsInTable(restaurants);
